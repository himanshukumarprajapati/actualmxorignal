...
import com.actualmx.actualmxnew.adapter.OtherRecycleViewAdapterNew;
...
public class OtherNewsFragmentListType extends Fragment implements PostDataExecute ,ForceListner,MyFragments {
private View rootView;
    ...
    private OtherRecycleViewAdapterNew otherRecycleViewAdapter;
    private ArrayList<NewsModel> datanewList= new ArrayList<>();

    public OtherNewsFragmentListType() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        try {
            otherRecycleViewAdapter = new OtherRecycleViewAdapterNew(getActivity(),datanewList,
        ...
        otherRecyclerView.addOnScrollListener(new RecyclerViewScrollListener(manager) {
            ...
            public void onLoadMore(int current_page) {
                ...
                Gson gson = new Gson();
                String JsonBody = gson.toJson(new Body(name,page+""));
                new ExecutePostRequest(getActivity(), 2, null,OtherNewsFragmentListType.this,JsonBody)
                        .execute("http://www.actualmx.com/backup/articlelist.php");
    ...
    public void forceLoding(String name) {
        OtherNewsFragmentListType.this.name = name;
        progressBar.setVisibility(View.VISIBLE);
        RequestBody formBody = new FormEncodingBuilder()
                .add("category_name", "noticias")
                .add("page", String.valueOf(1))
