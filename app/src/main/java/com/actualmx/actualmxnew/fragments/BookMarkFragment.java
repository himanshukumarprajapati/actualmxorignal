...
import com.actualmx.actualmxnew.adapter.BookMarkAdapter;
...
public class BookMarkFragment extends Fragment implements PostDataExecute ,ForceListner,MyFragments {
private View rootView;
    ...
    private BookMarkAdapter otherRecycleViewAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        datanewList =dbHandler.getBookmarks();
        ...
        try {
            otherRecycleViewAdapter = new BookMarkAdapter(getActivity(),datanewList,
                    "BookMarks","http://www.actualmx.com/backup/articlelist.php" );
