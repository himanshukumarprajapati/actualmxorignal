 ...
 */
public class OtherRecycleViewAdapter extends RecyclerView.Adapter<OtherRecycleViewAdapter.ViewHolder>
    ...
    public OtherRecycleViewAdapter(Context context, ArrayList<NewsModel> moreNews, String name,
                                   String baseUrl) {
        super();
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int getType) {
        ...
        if (getType == HomeModelClass.TYPE_HEADER_VALUE) {
            ...
            view = inflater.inflate(R.layout.other_layout_main_list_item, null);
            viewHolder = new ViewHolder(view, getType);
        }
        return viewHolder;
    }
            ...
            case HomeModelClass.TYPE_GRID_VALUE:
                ...
                holder.childGridLeftLayout.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        detailIntent.putExtra("base_url", baseurl);
                        detailIntent.putExtra("post_date", model2.getPost_date());
                        context.startActivity(detailIntent);
                        ((Activity) context).overridePendingTransition(0, 0);
